...
def user_cf(user_id, item_id, user_to_similar_user, user_to_rating, topn=10):
    ...
    #     item_scores[item] += sim_user对item的评分 * sim_user与userA的
    pred_score = 0
    count = 0
    # 遍历前topn个相似用户
